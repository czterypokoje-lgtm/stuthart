...
const topBrands = [
  {
    ...
    models: [
      { slug: 'golf', name: 'Golf', years: 'Alle Baujahre (inkl. MQB & SFD)' },
      { slug: 'polo', name: 'Polo', years: 'Alle Baujahre' },
      { slug: 'passat', name: 'Passat', years: 'B5, B6, B7, B8, B9' },
      { slug: 'transporter', name: 'Transporter (T4/T5/T6)', years: 'Alle Baujahre' }
    ],
  },
  {
    ...
    models: [
      { slug: '1er', name: '1er', years: 'E87, F20, F40' },
      { slug: '3er', name: '3er', years: 'E46, E90, F30, G20' },
      { slug: '5er', name: '5er', years: 'E39, E60, F10, G30' },
      { slug: 'x3-x5', name: 'X3 & X5', years: 'Alle Baujahre' }
    ],
  },
  {
    slug: 'mercedes', name: 'Mercedes', nameSlug: 'mercedes', priority: 'P1',
    ...
    models: [
      { slug: 'a-klasse', name: 'A-Klasse', years: 'W169, W176, W177' },
      { slug: 'c-klasse', name: 'C-Klasse', years: 'W203, W204, W205, W206' },
      { slug: 'e-klasse', name: 'E-Klasse', years: 'W211, W212, W213' },
      { slug: 'sprinter', name: 'Sprinter', years: 'W906, W907' }
    ],
  },
  {
    ...
    models: [
      { slug: 'a3', name: 'A3', years: '8L, 8P, 8V, 8Y' },
      { slug: 'a4', name: 'A4', years: 'B5, B6, B7, B8, B9' },
      { slug: 'a6', name: 'A6', years: 'C5, C6, C7, C8' },
      { slug: 'q5', name: 'Q5', years: 'Alle Baujahre' }
    ],
  },
  {
    slug: 'skoda', name: 'Skoda', nameSlug: 'skoda', priority: 'P1',
    ...
    models: [
      { slug: 'octavia', name: 'Octavia', years: 'Alle Generationen' },
      { slug: 'fabia', name: 'Fabia', years: 'Alle Generationen' },
      { slug: 'superb', name: 'Superb', years: 'Alle Generationen' },
      { slug: 'kodiaq', name: 'Kodiaq', years: 'Alle Baujahre' }
    ],
  },
  {
    slug: 'opel', name: 'Opel', nameSlug: 'opel', priority: 'P2',
    system: 'GM PATS / PSA',
    ...
    models: [
      { slug: 'corsa', name: 'Corsa', years: 'C, D, E, F' },
      { slug: 'astra', name: 'Astra', years: 'G, H, J, K, L' },
      { slug: 'insignia', name: 'Insignia', years: 'Alle Generationen' }
    ],
  },
  {
    slug: 'ford', name: 'Ford', nameSlug: 'ford', priority: 'P2',
  ...
  },
  {
    ...
    models: [
      { slug: 'leon', name: 'Leon', years: 'Alle Generationen' },
      { slug: 'ibiza', name: 'Ibiza', years: 'Alle Generationen' },
  ...
  },
  {
    ...
    models: [
      { slug: 'clio', name: 'Clio', years: 'Alle Generationen' },
      { slug: 'megane', name: 'Megane (Keycard)', years: 'Alle Generationen' },
  ...
  },
  {
    ...
    models: [
      ...
      { slug: 'ducato', name: 'Ducato', years: 'Alle Generationen' },
      { slug: 'panda', name: 'Panda', years: 'Alle Baujahre' }
    ],
  },
  {
    slug: 'toyota', name: 'Toyota', nameSlug: 'toyota', priority: 'P2',
  ...
  {
    slug: 'kia', name: 'Kia', nameSlug: 'kia', priority: 'P3',
  ...
  {
    slug: 'peugeot', name: 'Peugeot', nameSlug: 'peugeot', priority: 'P3',
    system: 'BSI / PSA',
    ...
    models: [
      { slug: '208', name: '208', years: 'Alle Baujahre' },
      { slug: '308', name: '308', years: 'Alle Baujahre' },
      { slug: '2008', name: '2008', years: 'Alle Baujahre' }
    ],
  },
  {
    ...
    models: [
      { slug: 'sandero', name: 'Sandero', years: 'Alle Baujahre' },
      { slug: 'duster', name: 'Duster', years: 'Alle Baujahre' }
    ],
  },
  {
    slug: 'volvo', name: 'Volvo', nameSlug: 'volvo', priority: 'P3',
    system: 'CEM / KVM',
  ...
  {
    slug: 'nissan', name: 'Nissan', nameSlug: 'nissan', priority: 'P3',
    system: 'NATS / BCM',
  ...
  {
    slug: 'mazda', name: 'Mazda', nameSlug: 'mazda', priority: 'P3',
    ...
    models: [
      { slug: 'mazda3', name: 'Mazda3', years: 'Alle Baujahre' },
      { slug: 'cx-5', name: 'CX-5', years: 'Alle Baujahre' },
      { slug: 'mx-5', name: 'MX-5', years: 'Alle Baujahre' }
    ],
  },
  {
    slug: 'citroen', name: 'Citroen', nameSlug: 'citroen', priority: 'P3',
    system: 'PSA BSI',
  ...
  {
    slug: 'mini', name: 'Mini', nameSlug: 'mini', priority: 'P3',
    system: 'CAS / FEM / BDC',
    ...
    models: [
      { slug: 'cooper', name: 'Cooper', years: 'R50, R56, F56' },
      { slug: 'countryman', name: 'Countryman', years: 'R60, F60' }
    ],
  },
  {
    ...
    models: [
      { slug: '911', name: '911', years: '996, 997, 991, 992' },
      { slug: 'cayenne', name: 'Cayenne', years: 'Alle Generationen' },
      { slug: 'macan', name: 'Macan', years: 'Alle Baujahre' }
    ],
  }
];

const content = `import { Brand } from '@/types/brand';

export const BRANDS: Brand[] = ${JSON.stringify(topBrands, null, 2)};
`;

fs.writeFileSync('src/config/brands.ts', content);
