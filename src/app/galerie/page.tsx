    ...
    <main>
      <section style={{ background: 'linear-gradient(135deg, #070e1a 0%, #0a1628 100%)', padding: '5rem 2rem', textAlign: 'center' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '1.1rem', maxWidth: 650, margin: '0 auto' }}>
          Sehen Sie sich unsere 26 aktuellen Schlüsselreparaturen, Schlüsselprogrammierungen und Smart-Key-Lernprojekte vor Ort in <Link href="/standorte/stuttgart" style={{color: 'var(--orange-500)', textDecoration: 'underline'}}>Stuttgart</Link>, <Link href="/standorte/sindelfingen" style={{color: 'var(--orange-500)', textDecoration: 'underline'}}>Sindelfingen</Link>, <Link href="/standorte/boeblingen" style={{color: 'var(--orange-500)', textDecoration: 'underline'}}>Böblingen</Link>, <Link href="/standorte/esslingen" style={{color: 'var(--orange-500)', textDecoration: 'underline'}}>Esslingen</Link>, <Link href="/standorte/ludwigsburg" style={{color: 'var(--orange-500)', textDecoration: 'underline'}}>Ludwigsburg</Link> und im Umkreis von 50km an.
        </p>
      </section>
      ...
      <div className="container" style={{ padding: '4rem 2rem' }}>
        ...
        <div style={{ marginBottom: '4rem', background: 'var(--color-bg-alt)', padding: '2.5rem', borderRadius: '16px', border: '1px solid var(--color-border)' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '2.5rem', alignItems: 'center' }}>
            <div>
              <span className="section-label" style={{ color: 'var(--orange-500)', fontWeight: 700, fontSize: '0.75rem', letterSpacing: '0.1em' }}>STUTTGART WERKSTATT & MOBILER SERVICE</span>
