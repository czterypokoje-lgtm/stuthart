...
export const TOP_BRANDS = [
  ...
  { name: 'Skoda', slug: 'skoda-autoschluessel-nachmachen', svg: '/brands/skoda_sleutel_nachmachen.webp' },
  ...
  { name: 'Opel', slug: 'opel-autoschluessel-nachmachen', svg: '/brands/opel_sleutel_nachmachen.webp' },
  ...
  { name: 'Seat', slug: 'seat-autoschluessel-nachmachen', svg: '/brands/seat_sleutel_nachmachen.webp' },
  { name: 'Hyundai', slug: 'hyundai-autoschluessel-nachmachen', svg: 'https://cdn.simpleicons.org/hyundai/001E50' },
  { name: 'Kia', slug: 'kia-autoschluessel-nachmachen', svg: '/brands/kia_sleutel_nachmachen.svg' },
  { name: 'Fiat', slug: 'fiat-autoschluessel-nachmachen', svg: '/brands/fiat_sleutel_nachmachen.webp' },
  { name: 'Nissan', slug: 'nissan-autoschluessel-nachmachen', svg: 'https://cdn.simpleicons.org/nissan/001E50' },
  { name: 'Citroën', slug: 'citroen-autoschluessel-nachmachen', svg: '/brands/citroen_sleutel_nachmachen.webp' },
  { name: 'Volvo', slug: 'volvo-autoschluessel-nachmachen', svg: '/brands/volvo_sleutel_nachmachen.webp' },
  { name: 'Honda', slug: 'honda-autoschluessel-nachmachen', svg: '/brands/honda_sleutel_nachmachen.webp' },
  { name: 'Land Rover', slug: 'land-rover-autoschluessel-nachmachen', svg: '/brands/land_rover_sleutel_nachmachen.webp' },
  { name: 'Porsche', slug: 'porsche-autoschluessel-nachmachen', svg: '/brands/porsche_sleutel_nachmachen.webp' },
];
